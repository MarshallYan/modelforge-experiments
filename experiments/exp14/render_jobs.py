...
if __name__ == "__main__":
    ...
    range_number_of_radial_basis_functions = [16, 32, 64, 128, 256]
    range_number_of_interaction_modules = [1, 3, 6, 9]
    range_number_of_filters = [32, 64, 128, 256, 512]
    range_number_of_per_atom_features = [32, 64, 128, 256, 512]


    count = 0
    for seed in range_seed:
        for data_split in range_data_split:
                ...
                for number_of_interaction_modules in range_number_of_interaction_modules:
                    for number_of_filters in range_number_of_filters:
                        for number_of_per_atom_features in range_number_of_per_atom_features:
                            # config names
                            experiment_name = f"SchNet_QM9{count:04d}"
                            tags = [
                                f"{seed=}",
                                f"{data_split=}",
